...
Ajuste as configurações em .env antes e no diretório assets crie suas chaves para acesso a máquina (UBUNTU) e ao github para clonar o projeto caso queira clonar do seu github<br>
